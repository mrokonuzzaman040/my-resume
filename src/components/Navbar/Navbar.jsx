...
const Navbar = () => {
    return (
        <header
            className="fixed glass inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-md border border-gray-100 bg-indigo-700 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-3xl lg:max-w-screen-lg">
            <div className="px-4">
